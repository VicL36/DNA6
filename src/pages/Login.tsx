        ...
        >
          <Card className="glass-morphism border-0 shadow-glass card-hover">
            ...
            <CardContent className="space-y-6">
              ...
              {/* Google Login Button - Only show if available */}
              {googleAvailable && (
                <>
                  <Button
                    type="button"
              ...
              {!googleAvailable && (
                <div className="bg-neon-orange/10 border border-neon-orange/30 rounded-lg p-4 mb-4">
                  <div className="flex items-center gap-2 text-neon-orange">
                    ...
                    <span className="text-sm font-medium">Login com Google temporariamente indisponível</span>
                  </div>
                  <p className="text-xs text-text-secondary mt-1">Use email e senha para acessar sua conta</p>
                </div>
              )}
